...
public class BrowserSelect {
	...
	public static void startApplication(String browserName,String AppURL)
	{
		...
		{
			System.setProperty("webdriver.chrome.driver",relativePath+"\\src\\main\\resources\\BrowserDrivers\\chromedriver.exe");
			driver=new ChromeDriver();
			driver.manage().window().maximize();
		}
		// driver.manage().timeouts().implicitlyWait(20,TimeUnit.SECONDS);
		 String getUrl = ConfigReader.ConfigurationReader(AppURL);
